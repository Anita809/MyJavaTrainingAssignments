...
class Flight1 {
	...
	public Flight1(int flightNumber, String flightName, String sourceCity, String targetCity) {
		super();
	...
	public Flight1(int flightNumber) {
		super();
		this.flightNumber = flightNumber;
	}

	public Flight1(int flightNumber, String sourceCity, String targetCity) {
		super();
		this.flightNumber = flightNumber;
		this.sourceCity = sourceCity;
		this.targetCity = targetCity;
	...
	public Flight1(int flightNumber, String flightName) {
		super();
		this.flightNumber = flightNumber;
		this.flightName = flightName;
	}
